...
from settings import label_list, label_path, labelfunc_path_end, preproc_func, preproc_func_path_end, table_path, table_end
...
if __name__ == '__main__':
    ...
    for subject_type in subject_types:
        if subject_type == 'patient':
            local_data_path = './preproc/output/patients/'
        else: 
            local_data_path = './preproc/output/controls/'
        ...
        for subject_path in glob.glob(label_path + "*" + labelfunc_path_end):
            ...
            func_file = local_data_path + subject_id + '/functional' + preproc_func_path_end 
