...
table_path = '/projects/homology/output/tablesTEST/'
...
# Iterate over subjects
    for subject_id in os.listdir(data_path):
        ...
        if test:
            ...
            table_indices = [ [1,2], [2,3], [4,5], [5,6],
                [1,2], [2,3], [4,5], [5,6], [1,3],
                [1,2], [2,3], [4,5], [5,6], [1,3], [4,6],
                [1,2], [2,3], [4,5], [5,6], [1,3,4], [3,4,6],
                [1,2], [2,3], [4,5], [5,6], [1,3,4], [3,4,6], [2,5],
                [1,2,5], [2,3,5], [1,4,5], [3,5,6], [1,3,4], [3,4,6],
                [1,2,5], [2,3,5], [1,4,5], [3,5,6], [1,3,4], [3,4,6], [1,2,3], [4,5,6]]
